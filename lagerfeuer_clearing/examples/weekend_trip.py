...
def main():
    ...
    gas_index = next((i for i, e in enumerate(manager.expenses) 
                    if e["subject"] == "Gas"), None)
    ...
    cooking_index = next((i for i, e in enumerate(manager.expenses) 
                        if e["subject"] == "Special ingredients"), None)
